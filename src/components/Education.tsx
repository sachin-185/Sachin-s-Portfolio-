...
export default function Education() {
  ...
  return (
    <section id="education" className="py-32 px-6 bg-[#050505] relative overflow-hidden">
      <div className="container mx-auto">
        ...
        <div className="max-w-3xl mx-auto relative border-l-2 border-white/10 ml-4 md:mx-auto">
          {EDUCATION.map((edu, i) => (
            <motion.div
              key={edu.institution}
            ...
            >
              ...
              <div className="relative p-8 md:p-10 rounded-3xl bg-[#0a0a0a] border border-white/5 hover:border-[#c6ff00]/30 transition-all duration-500 overflow-hidden flex flex-col justify-between min-h-[220px]">
                ...
                <div className="relative z-10 flex flex-col gap-6">
                  <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-4">
                    ...
                    <div className="w-16 h-16 rounded-2xl overflow-hidden bg-white shrink-0 flex items-center justify-center p-2 border border-white/10">
                      <img
                        src={edu.image}
                        alt={edu.institution}
                  ...
                  <div className="flex flex-col gap-1.5 mt-2">
                    <h3 className="text-2xl font-bold tracking-tight text-white leading-snug group-hover:text-[#c6ff00] transition-colors duration-300 font-poppins">
                      {edu.institution}
                    </h3>
                    <p className="text-neutral-400 font-light text-base leading-normal">
                      {edu.degree}
                    </p>
                  </div>
                </div>
                ...
                <div className="relative z-10 flex items-center gap-2 mt-6 text-neutral-500 text-xs font-mono border-t border-white/5 pt-4">
